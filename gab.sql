...
-- Dumping data for table gab.absence: ~3 rows (approximately)
...
INSERT IGNORE INTO `absence` (`id`, `id_etudiant`, `crn_horaire`, `type_absence`, `is_old`, `module`, `professeur`, `date_absence`) VALUES
	...
	(4, 1, '8-10', 'Absence justifiée', 0, 'programmation en c avancée', 7, '2017-05-19'),
	(5, 1, '8-10', 'Absence non-justifiée', 0, 'programmation web', 7, '2017-05-15');
...
-- Dumping data for table gab.etudiant: ~2 rows (approximately)
...
INSERT IGNORE INTO `module` (`id`, `nom_module`, `nature`, `enseigne_par`) VALUES
	(2, 'programmation en c avancée', 'Module scientifique et technique', 1),
	(3, 'programmation web', 'Module scientifique et technique', 1),
	(4, 'architectures des ordinateurs et  assembleur ', 'Module scientifique et technique', 1),
	(5, 'compilation et théorie des langages', 'Module scientifique et technique', 1),
	(6, 'système d\'exploitation', 'Module scientifique et technique', 1);
