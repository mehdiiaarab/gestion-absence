...
-- Dumping data for table gab.etudiant: ~3 rows (approximately)
...
INSERT IGNORE INTO `etudiant` (`id`, `id_user`, `cin`, `nom`, `cne`, `prenom`, `date_naissance`, `adresse`, `lieu_naissance`, `telephone`, `email`) VALUES
	(1, 8, 'LE20225', 'Ahanuk', '1122558899', 'Fidaous', '1996-02-11', 'Martil', 'Martil', '06666666', 'ahannuk@gmail.com'),
	(2, 9, 'LE20257', 'Aarab', '2222222', 'Mehdi', '2017-05-25', 'Hello World', 'Khénifra', '+212663658539', 'dev.mehdiaarab@gmail.com'),
	(3, 10, '123456789', 'adib', '222222222', 'houssam', '2017-05-17', 'adress rue appart', 'lieu de naissance', '0655555555', 'adib@gmai.com'),
	(4, 11, 'ss', 'ss', 'ss', 'ss', '2018-02-02', 'ss', 'ss', 'ss', 'ss@ss');
